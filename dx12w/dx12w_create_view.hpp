...
namespace dx12w
{
	...
	{
		D3D12_SHADER_RESOURCE_VIEW_DESC desc{};
		// ViewDimensioがBufferの場合はFormatはUnknown固定っぽい
	...
	inline void create_buffer_UAV(ID3D12Device* device, D3D12_CPU_DESCRIPTOR_HANDLE cpuHandle, ID3D12Resource* resource,
